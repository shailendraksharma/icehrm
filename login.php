				...
				<div class="login-form">
					...
					<form id="loginForm" action="login.php" method="POST">
						...
						<div class="clearfix">
							...
							<a href="https://twitter.com/icehrmapp" target="_blank" style="float:right;"><img src="<?=BASE_URL?>images/32x32-Circle-53-TW.png"/></a>
							<a href="https://www.facebook.com/pages/ICE-Hrm/224670887674102" target="_blank" style="float:right;margin-right: 7px;"><img src="<?=BASE_URL?>images/32x32-Circle-54-FB.png"/></a>
						</div>
					</form>
